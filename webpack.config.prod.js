...
module.exports = {
    ...
    entry: {
        ...
        vendor: ['lodash', 'react', 'react-dom', 'react-redux', 'history', 'react-router', 'rc-animate', 'superagent', 'superagent-jsonp', 'js-cookie', 'react-router-redux'],
    },
    output: {
        // The build folder.
        path: paths.appBuild,
        ...
        rules: [
            ...
            },
            {
                ...
                oneOf: [
                    ...
                    {
                        test: /\.(js|jsx)$/,
                        include: [paths.appSrc, path.resolve(__dirname, '../node_modules/sslib-react/dist/')],
                    ...
                    },
                    {
                        ...
                        include: [
                            ...
                            path.resolve(__dirname, '../node_modules/sslib-react/svg/'),  // sslib-react的svg文件目录
